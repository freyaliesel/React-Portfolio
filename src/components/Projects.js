            ...
            <div className="container">
                <Link id="dately" className="heroproject project" to="#">
                    ...
                    <img
                        ...
                        alt="preview image of the web app Dately"
                    />
                </Link>
                <Link id="manyfest" className="project" to="">
                    ...
                    <img
                        ...
                        alt="preview image of a game made in scratch"
                    />
                </Link>
                <Link id="weather" className="project" to="">
                    ...
                    <img
                        ...
                        alt="preview image of a weather dashboard web app"
                    />
                </Link>
                <Link id="scheduler" className="project" to="">
                    ...
                    <img
                        ...
                        alt="preview image of a worday schedule web app"
                    />
                </Link>
